...
const (
	CategoryService_Create_FullMethodName = "/assortimentpb.CategoryService/Create"
)
...
func (c *categoryServiceClient) Create(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (UnimplementedCategoryServiceServer) Create(context.Context, *emptypb.Empty) (*emptypb.Empty, error) {
...
func _CategoryService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).Create(ctx, req.(*emptypb.Empty))
	}
...
var CategoryService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "assortimentpb.CategoryService",
	...
	Metadata: "assortimentpb/categorypb.proto",
}
